...
rain_new <- read_html("https://www.stringmeteo.com/synop/prec_month.php?year=2023&month=8&ord=num&rep_1113=on&submit=%D0%9F%D0%9E%D0%9A%D0%90%D0%96%D0%98#sel") %>%
...
temp %>%
  ...
  labs(x = "Години", y = "Средна месечна температура (ºС)", 
