...
temp |> 
  ...
  scale_fill_manual(values = c("1" = "red", "2" = "orange" ,
                               "3" = "green", "4" = "#0096FF", "5" = "blue"), 
                    labels = c("1" = "Моного топло", 
                               "2" = "Топло", 
                               "3" = "Умерено",
                               "4" = "Хладно",
                               "5" = "Много хладно")) +
...
rain |> 
  ...
  scale_y_continuous(expand = expansion(mult = c(0, 0.7)), n.breaks = 10) +
  scale_fill_manual(values = c("1" = "blue" , "2" = "#0096FF" , 
                               "3" = "green", "4" = "orange", "5" = "red"), 
                    labels = c("1" = "Много дъждовно", 
                               "2" = "Дъждовно", 
                               "3" = "Умерено",
                               "4" = "Сухо",
                               "5" = "Много сухо")) +
...
labels <- c("1" = "Много топло", "2" = "Топло" ,
            "3" = "Умерено", "4" = "Хладно", "5" = "Много хладно")
...
rain |> filter(elev < 1200) |> 
  ...
  coord_cartesian(expand = F, ylim = c(0, 80)) +
